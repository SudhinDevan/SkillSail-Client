      ...
      <div className="p-3">
        ...
        <div className="container mx-auto p-3 border-gray-200">
          <div className="flex flex-col sm:flex-row">
            <div className="h-72 p-3 flex flex-row cursor-pointer">
              {/* plus component */}
              {courses.map((course) => (
                <div
                  key={course._id}
                  className="p-4 h-60 border mr-3 w-80 rounded shadow-sm flex flex-col items-center justify-center bg-gray-300 hover:bg-gray-400"
                >
                  <img
              ...
              {/* plus component */}
              <div className="p-4 h-60 w-1/3 border flex flex-col justify-center items-center rounded shadow-sm border-dashed border-black  bg-gray-300 hover:bg-gray-400">
                <img
                  src="../../plus.png"
                  alt="plus"
